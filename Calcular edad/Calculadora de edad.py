...
def calculateAge():
    ...
    Label(text=f"Hi {name_value.get()}! you age is: {age}", font=("arial", 15, "bold")).grid(row=6, column=1)
...
button = Button(text="Calculate Age", font=("arial", 15,"bold"), fg="white", bg="#21130d", command=calculateAge)
